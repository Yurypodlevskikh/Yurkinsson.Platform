<template>
    <div class="delete-account-section">
        ...
        <form id="delete-account-form" @submit.prevent="onSubmit" class="form-actions">
        ...
        <div class="account-btn-footer">
            <ButtonSpeedUp :btnType="'submit'" title="Request account deletion" :disabled="isSubmitting" form="delete-account-form">
                <template #icon>
